                            ...
                            for (int jj = 0; jj < 4; jj++) {
                                if (S_block[ii][jj]) {
                                    if (S_Map[PC_2[0] + ii][PC_2[1] + jj] == '*') {
                                        ...
                                        if (S_player == 1) {
                                            if (S_Map[PC_2[0] + ii + 1][PC_2[1] + jj] == 'O' || S_Map[PC_2[0] + ii - 1][PC_2[1] + jj] == 'O' || S_Map[PC_2[0] + ii][PC_2[1] + jj + 1] == 'O' || S_Map[PC_2[0] + ii][PC_2[1] + jj - 1] == 'O') {
                                                Connected_Star = true;
                                            }
                                        } else {
                                            if (S_Map[PC_2[0] + ii + 1][PC_2[1] + jj] == 'X' || S_Map[PC_2[0] + ii - 1][PC_2[1] + jj] == 'X' || S_Map[PC_2[0] + ii][PC_2[1] + jj + 1] == 'X' || S_Map[PC_2[0] + ii][PC_2[1] + jj - 1] == 'X') {
                                                Connected_Star = true;
                                            }
                                        }
                                    }
