          ...
          for (int jj = 0; jj < 4; jj++) {
              if (block[ii][jj]) {
                  if (player1) {
                      ...
                      if(temporary_map[x_of_block + ii + 1][y_of_block + jj] == 'O' || temporary_map[x_of_block + ii - 1][y_of_block + jj] == 'O' ||
                          temporary_map[x_of_block + ii ][y_of_block + jj + 1] == 'O' || temporary_map[x_of_block + ii ][y_of_block + jj - 1] == 'O')
                      {
                          connected = connected + 1;
                      }
                  } else {
                      temporary_map[x_of_block + ii][y_of_block + jj] = 'X';
                      if(temporary_map[x_of_block + ii + 1][y_of_block + jj] == 'X' || temporary_map[x_of_block + ii - 1][y_of_block + jj] == 'X' ||
                          temporary_map[x_of_block + ii ][y_of_block + jj + 1] == 'X' || temporary_map[x_of_block + ii ][y_of_block + jj - 1] == 'X')
                      {
                          connected = connected + 1;
                      }
                  }
